...
for (let i = 0; i < IDarr.length; i++) {
  ...
  document.getElementById("tracks").innerHTML += ("#" + (i+1) + ":").padEnd(4) + "<a href=https://dashcraft.io/?t=" + IDarr[i] + " target='_blank'>" + ("https://dashcraft.io/?t=" + IDarr[i]).padEnd(50) + "</a> by " + mappers[i] + "<br>";
}
